...
search_speed = 2.0  # m/s speed to search for marker in waypoint stage
...
ALTITUDE = 2.50  # Altitude to take off to (meters)
...
def capture_frames(queue):
    ...
    zed.set_camera_settings(sl.VIDEO_SETTINGS.EXPOSURE, 15)  # -1 is default i think
